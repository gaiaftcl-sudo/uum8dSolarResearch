...
func printPublishedReference() {
    ...
    print("670670 transcripts. WINDOW COUNTS ARE PER STRAND LENGTH, never one figure for the run:")
    print("a 20-mer has 1467336203 scoreable windows, and a longer strand has fewer. An earlier")
    print("revision printed 1467336293 as though it were a property of the run — it was one")
    print("arbitrary strand's count, inflated by windows containing an N that the mismatch")
    print("early-exit reached before the invalid-base check. Corrected; see the file header.")
