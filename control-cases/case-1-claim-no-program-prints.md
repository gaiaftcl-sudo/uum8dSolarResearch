...
PROGRAM        zilganersen-offtarget-screen-v2
...
WHERE_THE_LAW_LIVES  reproduce/zilganersen-offtarget-screen-v2.swift
...
REPRODUCE      cd reproduce && xcrun swiftc -O -swift-version 5 zilganersen-offtarget-screen-v2.swift -o /tmp/run && curl -sL <gencode v50 transcripts fasta> | gunzip -c | /tmp/run
