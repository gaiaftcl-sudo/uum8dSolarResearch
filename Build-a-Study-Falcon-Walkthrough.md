...
**Status: teaching surface — claim page and IDE template are live.** Falcon is the worked example of a full study *and* a supporting app on this OS. Walk the four acts on this page. You do not need the prove plan first.
