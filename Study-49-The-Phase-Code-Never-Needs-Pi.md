...
to `wasm32-wasip1`, where it prints the same bytes under wasmtime — measured. It will open in the
Studio once the Studio's pinned commit advances to carry it; until then this command line is the way
to run it.
