...
![WIN — IUT stalls on paper; UUM-8D projects on a runtime](images/iut-uum8d-win-card.svg)
...
![IUT stall: symbolic bridges with no runtime](images/iut-stall.svg)
...
![Three moves: embed → Jordan-bond → vQbit check](images/iut-uum8d-three-moves.svg)
...
![Jordan bond + vQbit gate](images/iut-uum8d-jordan-vqbit.svg)
...
![IUT paper stall → UUM-8D topological projection](images/iut-uum8d-win.gif)
