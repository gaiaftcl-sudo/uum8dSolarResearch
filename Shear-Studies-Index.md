...
> **Start here:** [**The lattice holds**](The-Lattice-Holds) — Einstein’s continuum missed; Affine’s whole-integer lattice held. [**Impact study**](Impact-Study-Death-of-Continuous-Shear) — the equations that are no longer courts. [**Explore the live courts**](Affine-Earth-Lattice-Endpoints) — `GET https://affine.earth/language-invariant/games` then `POST /language-invariant/game/{domain}/ingest`. [**Zero Float · Zero Shear**](Zero-Float-Zero-Shear-Paradigm.md) · [Readers’ guide](Shear-Studies-Readers-Guide.md) · [**UUM-8D vs IUT — WIN**](UUM8D-vs-IUT-Topological-Projection.md) · [White paper](Shear-Studies-White-Paper.md) · Studies **11 + 12 + 13** conjecture WINs sealed; Study 07 + Study 06 **LAW FROZEN**; Study 10 Fermi/DM **CHARTER SEALED**; eclipse crossed 2026-08-12 — pinned-archive verdict ~2026-08-30.
...
| 4 | [Study 04 — Tsunami vs storm surge](Study-04-Tsunami-vs-Storm-Surge.md) · [Results (partial)](Study-04-Tsunami-vs-Storm-Surge-Results.md) | **PARTIAL_CORPUS_SEAL** — 2/2 tsunami gauge WIN; Sandy adversary WIN; Tonga VOID_NEED_PRESSURE | Integer-mm first-onset vs chart minutes on CO-OPS pulls. Full multi-gauge Form + pressure branch still OPEN. |
...
| 6 | [Study 06 — Explosion vs earthquake](Study-06-Explosion-vs-Earthquake.md) · [Corpus](Study-06-Explosion-vs-Earthquake-Corpus.md) · [Results](Study-06-Explosion-vs-Earthquake-Results.md) · [Registry](Study-06-Explosion-vs-Earthquake-Registry.md) | **LAW FROZEN** — IC.MDJ 6/6 explosion WIN; 3/3 adversary reject | Catalog clock + 53±2 s travel + SNR ≥ 20,000 ppt on raw integer counts; near-site/collapse miss the appointment. IU.INCN VOID this seal. |
...
| 11 | [Study 11 — Ehrhart volume](Study-11-Ehrhart-Volume-Shear.md) · [Corpus](Study-11-Ehrhart-Volume-Corpus.md) · [Results](Study-11-Ehrhart-Volume-Results.md) · [**live geometry court**](Affine-Earth-Lattice-Endpoints) | **LAW FROZEN** — 5/5 WIN · 5/5 float adversary MISS · **LIVE** `POST /language-invariant/game/geometry/ingest` | Integer lattice counts in dilated polytopes recover exact Ehrhart volume; float triangulation shear-fails at \(t=12\). |
| 12 | [Study 12 — Quantum parallel repetition](Study-12-Quantum-Parallel-Repetition-Shear.md) · [Corpus](Study-12-Quantum-Parallel-Repetition-Corpus.md) · [Results](Study-12-Quantum-Parallel-Repetition-Results.md) · [**live chance court**](Affine-Earth-Lattice-Endpoints) | **LAW FROZEN** — 4/4 WIN · 4/4 float adversary MISS · **LIVE** `POST /language-invariant/game/chance/ingest` | CHSH classical ceiling \(3/4\) multiplies as \((3/4)^n\); float amplitude \(751/1000\) never names the appointment. |
| 13 | [Study 13 — Connes rigidity](Study-13-Connes-Rigidity-Shear.md) · [Corpus](Study-13-Connes-Rigidity-Corpus.md) · [Results](Study-13-Connes-Rigidity-Results.md) · [**live algebra court**](Affine-Earth-Lattice-Endpoints) | **LAW FROZEN** — 5/5 WIN · 5/5 float adversary MISS · **LIVE** `POST /language-invariant/game/algebra/ingest` | Group words walk the Eisenstein lattice; linking \((q,r)\) is rigid; float spectral proxy is offset by one. |
