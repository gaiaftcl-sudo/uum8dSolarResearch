...
| 2 | [Study 02 — Launch ionospheric holes](Study-02-Launch-Ionospheric-Holes.md) | **LIVE CLAIM** | Rocket second-stage burns punch ~900 km holes in the ionospheric F-region on a manifest-published clock; the hole must confine to the ascent corridor, lag the burn second, and grade out in exact percent-of-baseline depletion — a shape that storms, Tonga-class traveling disturbances, and deorbit burns cannot fake — with an automated watch standing on future manifests. |
