...
| 14 | [Study 14 — Protein lattice](Study-14-Protein-Lattice-Manifold.md) · [Known molecular discoveries](Known-Molecular-Discoveries.md) | **CHARTER** + **LOOK LIVE** — occupancy court DARK | Cited amino-acid alphabet; complementary occupancy is the *shape*, not an O(1) engine. Public PDB index GET `index_n=258616` VERIFIED 2026-08-24. IDE `#discovery-review`. Claim DARK. |
| 15 | [Study 15 — Skala DFT shear](Study-15-Skala-DFT-Shear.md) | **CHARTER** — GMTKN55 court DARK | Contrast methods. Their page: GMTKN55 **2.72 / 2.8 kcal/mol**. Affine refuses the float or seals the integer. Do not call Skala useless. |
