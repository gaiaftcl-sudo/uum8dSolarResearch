...
### 1 — E8, the rank-4 Eisenstein module the eight-dimensional register closes on

**A mathematical object with a public name, counted rather than estimated — and, since 2026-09-18, the
construction counted too.** In the same dimension and at the same covolume, E8 packs **exactly 16×**
denser than Z⁸ and touches **240** neighbours against Z⁸'s **16**; both minimal norms are now enumerated
and the 16 is derived from them. E8 is the free Z[ω]-module of rank 4 over the ternary tetracode:
enumerated at minimal Eisenstein norm 3, the construction has **240** minimal vectors, 216 + 24, index 9,
every one still admitted under multiplication by ω, with the Gram spectrum (1, 56, 126, 56, 1). Admission
is a residue check in F₃. The 2026-09-07 refusal that framed E8 against "a signal" is retired as a
category error; what the entry claims about the running substrate is marked DOCTRINE and kept outside
the seal.
