...
Exporter: `Study02AlarmLegacyProjector` · `cells/xcode/scripts/study-02-alarm-legacy-project.swift` · `scripts/study-02-alarm-legacy-project.sh`. Isolated `swiftc`. One-way projection.
