...
| 17 Chemistry InChIKey | **3** fixture rows | [17](Study-17-Chemistry-InChIKey.md) | [`#chemistry-inchi`](https://affine.earth/language-game/ide.html#chemistry-inchi) | **LAW FROZEN** + **LIVE CLAIM** |
| 18 Material STD | **3** fixture rows | [18](Study-18-Material-STD.md) | [`#material-std`](https://affine.earth/language-game/ide.html#material-std) | **LAW FROZEN** + **LIVE CLAIM** |
| 19 Go First Dice | **300** faces (5×60) | [19](Study-19-Go-First-Dice.md) | [`#gofirst-dice`](https://affine.earth/language-game/ide.html#gofirst-dice) | **LAW FROZEN** + **LIVE CLAIM** · Meyer 2023 cited · sibling of ERIC, not a dump |
...
| ERIC local archive | **78680** proteins · **46622** materials (`index_n=125302`) | [ERIC ingest review](ERIC-Ultimate-Ingest-Review.md) | [`#eric-archive`](https://affine.earth/language-game/ide.html#eric-archive) · play [`#disease-icd`](https://affine.earth/language-game/ide.html#disease-icd) [`#chemistry-inchi`](https://affine.earth/language-game/ide.html#chemistry-inchi) [`#material-std`](https://affine.earth/language-game/ide.html#material-std) | **LOOK LIVE · LOCAL ARCHIVE · PLAY VIA 16–18** — hosted hashes + integer aggregates. `label_kind=GENERATED_CANDIDATE`. ERIC nicknames are not keys. **0** public PDB/PubChem/ChEMBL/DailyMed ids. C-007 arms not ingested. |

**OPEN (no data) — only 03, 05, 08.** Those rows have no IDE hash because there is nothing to GET. ERIC does not supply SID / NMDB / µas.

**DARK court, data present — 01, 04, 06, 07, 10, 14, 15.** LOOK templates GET this ledger. They do not POST `eclipse` / `seismic` / `eht` / occupancy / kcal. Apex does not serve those `game_id`s. **16 / 17 / 18 / 19 are LIVE CLAIM** — ERIC Look plays through those hashes.
